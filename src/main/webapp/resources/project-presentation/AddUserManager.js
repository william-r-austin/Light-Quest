AddUserManager = (function() {
	...
	*/
	...
	function onChangeSkipEmailInput() {
	...
	function onSubmitUsernameInputForm(submitEvent) {
		// The form doesn't _actually_ need to be submitted.
		submitEvent.preventDefault();
		submitEvent.returnValue = false;
		console.log("Username input form submitted.");
	...
	function onSubmitReturningUsersForm(submitEvent) {
		submitEvent.preventDefault();
		submitEvent.returnValue = false;
		console.log("Returning users form submitted.");
	...
	function setupListener() {
		// Reset the skip email checkbox change event
		$("#skipEmailInput").off("change");
		$("#skipEmailInput").on("change", onChangeSkipEmailInput)
		
		// Reset the submit event for the new users form
		$("#usernameInputForm").off("submit");
		$("#usernameInputForm").on("submit", onSubmitUsernameInputForm);
		
		// Reset the submit event for the returning users form
		$("#returningUsersForm").off("submit");
		$("#returningUsersForm").on("submit", onSubmitReturningUsersForm);
